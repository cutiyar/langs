...
'Must enter title message'			=>	'دەبێت سەردێڕی بۆردەکە بنووسی.',
'Invalid e-mail message'			=>	'پۆستی ئەلکترۆنی بەڕیوەبەر هەڵەیە کە نووسیوتە.',
'Invalid webmaster e-mail message'	=>	'ناونیشانی وێبماستەری کە نووسیوتە هەڵەیە.',
...
'Options updated redirect'			=>	'هەڵبژاردنەکان نوێکرانەوە . دەگوێزرێیتەوە …',
...
'Base URL label'					=>	'بەستەری بنەڕەتی',
...
'Redirect time label'				=>	'کاتی گواستنەوە',
...
// Display Section
'Display subhead'					=>	'پیساندان',
'Version number label'				=>	'ژمارەی وەشان',
'Version number help'				=>	'ژمارەی وەشان لە بەرپێ پیشان بدە.',
...
'Smilies label'						=>	'خەندەکان لە ناو پەیامەکان',
'Smilies help'						=>	'خەندەکان بگۆڕە بۆ وێنۆچکەی بچووک.',
'Smilies sigs label'				=>	'خەندەکان لە ناو ئیمزا',
'Smilies sigs help'					=>	'خەندەکان بگۆڕە بۆ وێنۆچکەی بچووک لە ناو ئیمزا.',
'Clickable links label'				=>	'بەستەری کرتەکراو دروست بکە',
'Clickable links help'				=>	'When ەکراو دروست بکەB will automatically detect any URLs in posts and make them clickable hyperlinks.',
'Topic review label'				=>	'پێشبینی بابەت',
'Topic review help'					=>	' زۆرترین ژمارەی پەیام بۆ پیشاندان لە کاتی ناردنی پەیام (نوێترین لە سەرەتاوە( . 0 بنووسە بۆ نا چالاک کردن.',
'Topics per page label'				=>	'بابەت لە هەر پەڕەیکدا',
'Topics per page help'				=>	'ژمارەی بنەڕەتی پیشاندانی بابەت لە هەر پەڕەیەکدا ، بەکارهێنەران دەتوانن بیکەن لە ڕیکخستنەکانیان.',
'Posts per page label'				=>	'پەیام لە هەر پەڕەیەکدا',
'Posts per page help'				=>	'ژمارەی بنەڕەتی پیشاندانی پەیام لە هەر پەڕەیەکدا ، بەکارهێنەران دەتوانن چاکی بکەن لە ڕێکخستنەکانیان.',
...
// Features section
'Features subhead'					=>	'تایبەتمەندیەکان'
'Quick post label'					=>	'پەیامی خێرا',
...
'Users online label'				=>	'بەکارهێنەران لەسەر هێڵن ئێستا',
...
'Signatures label'					=>	'ئیمزا',
'Signatures help'					=>	'ڕێگە بدە بەکارهێنەران بتوانن ئیمزا بەکاربێنن لە پەیامەکانیان.',
'User ranks label'					=>	'پلەی ئەندامان',
...
'Reporting method label'			=>	'ڕێگەی ناردنی راپۆرتەکان',
'Internal'							=>	'ناوەکی',
'By e-mail'							=>	'پۆستی ئەلکترۆنی',
'Both'								=>	'هەردووکی',
...
'Max height label'					=>	'زۆرترین درێژی',
...
// E-mail section
'E-mail subhead'					=>	'پۆستی ئەلکترۆنی',
'Admin e-mail label'				=>	'پۆستی ئەلکترۆنی بەڕێوەبەر',
